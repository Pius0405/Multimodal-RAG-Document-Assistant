...
## 🤖 Models Used
Language Model: **Qwen/Qwen2.5-7B-Instruct** - A 7 billion parameter instruction-tuned language model for generating contextual responses<br><br>
Embedding Model: **all-MiniLM-L6-v2** - A lightweight sentence transformer for encoding documents and queries into semantic vectors<br><br>
